  ...
  const handleRemovePlace = useCallback(
    async function handleRemovePlace() {
      ...
      try {
        ...
        setUserPlaces(userPlaces); // rollback state in case of error
        setErrorUpdating({ message: error.message || "Failed to remove places!" });
      }
      setModalIsOpen(false);
    },
    [userPlaces]
  ...
  return (
    <>
      <Modal open={errorUpdating} onClose={handleError}>
        {errorUpdating && (
          <Error title="An Updating Error Occurred" message={errorUpdating.message} onConfirm={handleError} />
        )}
      </Modal>
